...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s hypothesize-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  hypothesize-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hypothesize transaction") + "\n" +
              "  hypothesize-tx [options] -create [commands]   " + _("Create hex-encoded hypothesize transaction") + "\n" +
              "\n";
