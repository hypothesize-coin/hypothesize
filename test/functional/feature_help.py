...
"""Verify that starting hypothesize with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hypothesize with -h for help text")
        ...
        self.log.info("Start hypothesize with -version for version information")
